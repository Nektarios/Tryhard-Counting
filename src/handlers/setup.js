...
module.exports.setup = (client) => {
    ...
    fs.readdir("./events/", (err, files) => {
        ...
        if (jsfiles.length <= 0) return console.log(chalk.red("There are no events to load..."));
    ...
    if (cmd_files.length <= 0) return console.log(chalk.red("There are no commands to load..."));
